...
export const historicSites: HistoricSiteType[] = [
	{
		id: 1,
		latitude: 46.809444,
		longitude: -71.210556,
		...
		activePeriodStart: 1608,
		activePeriodEnd: null,
		designations: [
			{
				type: DesignationTypeEnum.UnescoWorldHeritageSite,
				year: 1985,
				officialName: 'Historic District of Old Québec',
			},
		],
	},
	{
	...
	},
	{
		...
		attribution: 'Source: uneseco.org, licensed under CC-BY-SA IGO 3.0',
		activePeriodStart: -8000,
		activePeriodEnd: 1878,
		designations: [
			{
				type: DesignationTypeEnum.UnescoWorldHeritageSite,
				year: 1981,
				officialName: 'SGang Gwaay',
			},
		],
	},
	{
		...
		attribution: 'Source: uneseco.org, licensed under CC-BY-SA IGO 3.0',
		activePeriodStart: -7000,
		activePeriodEnd: 1918,
		designations: [
			{
				type: DesignationTypeEnum.UnescoWorldHeritageSite,
				year: 2019,
				officialName: "Writing-on-Stone / Áísínai'pi",
			},
		],
	},
	{
		...
		designations: [
			{
				type: DesignationTypeEnum.UnescoWorldHeritageSite,
				year: 2007,
				officialName: 'Sydney Opera House',
			},
		],
	},
	{
		...
		attribution: 'Source: uneseco.org, licensed under CC-BY-SA IGO 3.0',
		activePeriodStart: 1100,
		activePeriodEnd: null,
		designations: [
			{
				type: DesignationTypeEnum.UnescoWorldHeritageSite,
				year: 1998,
				officialName: 'La Grand-Place, Brussels',
			},
		],
	},
];
